...
import 'package:vinyl_groove_poc_11/screens/base_screen.dart';
import 'package:vinyl_groove_poc_11/screens/signup_screen.dart';
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        if (!RegExp(
                          ...
                          pwE = '비밀번호는 필수 값으로써 대문자 1자 이상 소문자 1자 이상의 형식을 따릅니다.';
                          setState(() {});
                          return;
                        }
